...
(function () {
  const config = {
    ...
    "tests": [{
      ...
      "spec": "count letters in %'doc'",
      "name": "count letters in %'doc' should count letters in \"abcc\"",
      "function":
        '<context id="1"><inputs><input>count</input></inputs><variables></variables><block collabId="item_12" s="reportEquals"><block collabId="item_20" s="evaluate"><block collabId="item_21" var="count"/><list><l>abcc</l></list></block><block collabId="item_15" s="reportNewList"><list><l>1</l><l>1</l><l>2</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l></list></block></block><receiver><sprite name="Sprite" collabId="item_-1" idx="1" x="0" y="0" heading="90" scale="1" rotation="1" draggable="true" costume="0" color="80,80,80" pen="tip" id="41"><costumes><list struct="atomic" id="42"></list></costumes><sounds><list struct="atomic" id="43"></list></sounds><variables></variables><blocks></blocks><scripts></scripts></sprite></receiver><origin><ref id="41"></ref></origin><context id="46"><inputs></inputs><variables></variables><receiver><ref id="41"></ref></receiver><origin><ref id="41"></ref></origin></context></context>',
    }, {
      "type": "CustomBlockTest",
      "spec": "count letters in %'doc'",
      "name": "count letters in %'doc' should skip non-alphabetic characters",
      "function":
        '<context id="1"><inputs><input>count</input></inputs><variables></variables><block collabId="item_34_4" s="reportEquals"><block collabId="item_39" s="reportListLength"><block collabId="item_34_9" s="evaluate"><block collabId="item_34_12" var="count"/><list><l>a b ! c</l></list></block></block><l>26</l></block><receiver><sprite name="Sprite" collabId="item_-1" idx="1" x="0" y="0" heading="90" scale="1" rotation="1" draggable="true" costume="0" color="80,80,80" pen="tip" id="14"><costumes><list struct="atomic" id="15"></list></costumes><sounds><list struct="atomic" id="16"></list></sounds><variables></variables><blocks></blocks><scripts></scripts></sprite></receiver><origin><ref id="14"></ref></origin><context id="19"><inputs></inputs><variables></variables><receiver><ref id="14"></ref></receiver><origin><ref id="14"></ref></origin></context></context>',
    }, {
      "type": "CustomBlockTest",
      "spec": "count letters in %'doc'",
      "name":
        "count letters in %'doc' should treat upper and lowercase as the same",
      "function":
        '<context id="1"><inputs><input>count</input></inputs><variables></variables><block collabId="item_47_4" s="reportEquals"><block collabId="item_47_10" s="evaluate"><block collabId="item_47_12" var="count"/><list><l>aAbBcCzZ</l></list></block><block collabId="item_53" s="reportNewList"><list><l>2</l><l>2</l><l>2</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>0</l><l>2</l></list></block></block><receiver><sprite name="Sprite" collabId="item_-1" idx="1" x="0" y="0" heading="90" scale="1" rotation="1" draggable="true" costume="0" color="80,80,80" pen="tip" id="41"><costumes><list struct="atomic" id="42"></list></costumes><sounds><list struct="atomic" id="43"></list></sounds><variables></variables><blocks></blocks><scripts></scripts></sprite></receiver><origin><ref id="41"></ref></origin><context id="46"><inputs></inputs><variables></variables><receiver><ref id="41"></ref></receiver><origin><ref id="41"></ref></origin></context></context>',
    }],
  };
